...
<form id="sn-form-1" action="${pageContext.request.contextPath}/controller" method="post" class="sn-default-form">
    ...
    <table class="pd-10px col-12">
        <tr id="z-checkbox-container">
            ...
            <td><input name="z" type="radio" value="1.5" id="checkbox2"><label for="checkbox2"> 1.5</label></td>
            <td><input name="z" type="radio" value="2" id="checkbox3"><label for="checkbox3"> 2</label></td>
            <td><input name="z" type="radio" value="2.5" id="checkbox4"><label for="checkbox4"> 2.5</label></td>
            <td><input name="z" type="radio" value="3" id="checkbox5"><label for="checkbox5"> 3</label></td>
        </tr>
    </table>
